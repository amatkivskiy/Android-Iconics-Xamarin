namespace AndroidIconicsSample
{
  ...
  public class PlaygroundActivity : Activity
  {
    protected override void OnCreate(Bundle savedInstanceState)
    {
      ...
      TextView tv1 = FindViewById<TextView>(Resource.Id.test1);
      ...
      TextView tv2 = FindViewById<TextView>(Resource.Id.test5);
      ...
      ImageView iv3 = FindViewById<ImageView>(Resource.Id.test3);
      ...
      Button b4 = FindViewById<Button>(Resource.Id.test4);
      new Iconics.IconicsBuilder().Ctx(this)
