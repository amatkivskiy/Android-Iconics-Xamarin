namespace Mikepenz.Octicons_typeface_library
{
  ...
  {
    private const string TtfFile = "octicons.ttf";
    ...
    public class Icon : Java.Lang.Object, IIcon
    {
      ...
      public static readonly Icon OctAlignmentAlign = new Icon('\uf08a', "oct_alignment_align");
      public static readonly Icon OctAlignmentAlignedTo = new Icon('\uf08e', "oct_alignment_aligned_to");
      public static readonly Icon OctAlignmentUnalign = new Icon('\uf08b', "oct_alignment_unalign");
      ...
      public static readonly Icon OctBeer = new Icon('\uf069', "oct_beer");
      ...
      public static readonly Icon OctHourglass = new Icon('\uf09e', "oct_hourglass");
      ...
      public static readonly Icon OctJumpDown = new Icon('\uf072', "oct_jump_down");
      public static readonly Icon OctJumpLeft = new Icon('\uf0a5', "oct_jump_left");
      public static readonly Icon OctJumpRight = new Icon('\uf0a6', "oct_jump_right");
      public static readonly Icon OctJumpUp = new Icon('\uf073', "oct_jump_up");
      ...
      public static readonly Icon OctMoveDown = new Icon('\uf0a8', "oct_move_down");
      public static readonly Icon OctMoveLeft = new Icon('\uf074', "oct_move_left");
      public static readonly Icon OctMoveRight = new Icon('\uf0a9', "oct_move_right");
      public static readonly Icon OctMoveUp = new Icon('\uf0a7', "oct_move_up");
      ...
      public static readonly Icon OctPlaybackFastForward = new Icon('\uf0bd', "oct_playback_fast_forward");
      public static readonly Icon OctPlaybackPause = new Icon('\uf0bb', "oct_playback_pause");
      public static readonly Icon OctPlaybackPlay = new Icon('\uf0bf', "oct_playback_play");
      public static readonly Icon OctPlaybackRewind = new Icon('\uf0bc', "oct_playback_rewind");
      ...
      public static readonly Icon OctPodium = new Icon('\uf0af', "oct_podium");
      ...
      public static readonly Icon OctPuzzle = new Icon('\uf0c0', "oct_puzzle");
      ...
      public static readonly Icon OctScreenFull = new Icon('\uf066', "oct_screen_full");
      public static readonly Icon OctScreenNormal = new Icon('\uf067', "oct_screen_normal");
      ...
      public static readonly Icon OctSplit = new Icon('\uf0c6', "oct_split");
      ...
      public static readonly Icon OctSteps = new Icon('\uf0c7', "oct_steps");
      ...
      public static IEnumerable<Icon> Values
      {
        get
        {
          ...
          yield return OctAlignmentAlign;
          yield return OctAlignmentAlignedTo;
          yield return OctAlignmentUnalign;
          ...
          yield return OctJumpDown;
          yield return OctJumpLeft;
          yield return OctJumpRight;
          yield return OctJumpUp;
          yield return OctKey;
          ...
          yield return OctMoveDown;
          yield return OctMoveLeft;
          yield return OctMoveRight;
          yield return OctMoveUp;
          ...
          yield return OctPin;
          yield return OctPlaybackFastForward;
          yield return OctPlaybackPause;
          yield return OctPlaybackPlay;
          yield return OctPlaybackRewind;
          ...
          yield return OctScreenFull;
          yield return OctScreenNormal;
